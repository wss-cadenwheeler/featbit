    ...
    : IMessageProducer
{
    ...
    {
        var isNotificationTopic = topic is Topics.ControlPlaneFeatureFlagChange or Topics.ControlPlaneLicenseChange or Topics.ControlPlaneSecretChange or Topics.ControlPlaneSegmentChange;
