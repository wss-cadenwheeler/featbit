...
namespace Api.Infrastructure.MQ.Postgres;
    ...
    : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        var tasks = new[]
        {
            ProcessAsync(Topics.ControlPlaneFeatureFlagChange, stoppingToken),
            ProcessAsync(Topics.ControlPlaneLicenseChange, stoppingToken),
            ProcessAsync(Topics.ControlPlaneSecretChange, stoppingToken),
            ProcessAsync(Topics.ControlPlaneSegmentChange, stoppingToken)
        };
