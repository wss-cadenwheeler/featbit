...
// seed workspace users (links the seeded user to the seeded workspace).
// Without this row, /api/v1/user/workspaces returns empty and the front-end
// auth guard silently logs the user out after login.
print('clean and seed collection: WorkspaceUsers')
db.WorkspaceUsers.deleteMany({})
...
print('collection seeded: WorkspaceUsers')
